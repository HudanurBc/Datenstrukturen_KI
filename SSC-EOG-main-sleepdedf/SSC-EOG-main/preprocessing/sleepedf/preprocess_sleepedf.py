...
def main():
    ...
    # Robustes Filtern: Nur tatsaechliche Subjekt-NPZ-Dateien einlesen (ignoriert pretext.pt, subject_py.npz, etc.)
    files = glob.glob(os.path.join(subjects_output_dir, "subject_[0-9]*.npz"))
